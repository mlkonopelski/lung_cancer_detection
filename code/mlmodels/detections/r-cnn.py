...
import os
import numpy as np
from torchvision.models import EfficientNet, EfficientNet_B7_Weights, efficientnet
...
def training():
    ...
    for _, images, labels in ds:
        ...
        # idx = rcnn_ds.positive_idx + rcnn_ds.negative_idx
        # sampler = WeightedRandomSampler()
        dl = DataLoader(rcnn_ds, batch_size=100, shuffle=True)
